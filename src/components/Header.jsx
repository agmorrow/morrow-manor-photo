...
import PrimaryLogo from "../assets/images/2.png";
            ...
            <div className="mx-auto max-w-2xl lg:max-w-none flex items-center justify-between">
              ...
              {navigation.map((item) => (
                    <Link
                      ...
                      as="a"
                      to={item.to}
                      className="block rounded-lg px-3 py-2 text-xl font-semibold leading-7 cursor-pointer text-black"
                ...
                <div className="space-y-2 py-6">
                  ...
                  <div className="flex flex-row items-center justify-between px-2 pt-4">
                    <div className="-m-1.5 p-1.5">
                      ...
                      <img className="h-8 w-auto" src={PrimaryLogo} alt="" />
                    </div>
